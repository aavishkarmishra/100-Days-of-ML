...
print("Accuracy of K-nearest neighbors : ",
      accuracy_score(labels_test, pred1)*100, "%")
...
print("Accuracy of AdaBoost : ", round(
    accuracy_score(labels_test, pred2)*100, 3), "%")
...
print("Accuracy of Random Forest : ", round(
    accuracy_score(labels_test, pred3)*100, 3), "%")
